...
const CustomersAgentNew = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const requestBody = {
      ...
      natureofbusiness:formData.natureofbusiness,//additional change field
    ...
    if (isSuccessfull) {
      try {
        const response = await  postDATA(requestBody,ApiRoutes.CUSTOMER_AGENTS.AGENT)
        if (response.data.statusCode === 200) {
       
          SuccessApiToast( "Agent Created Successfully");
          setFormData({
            userName: "",
            password: "",
            confirmPassword: "",
        ...
        ErrorApiAlert('Error Adding Agent');
      }
    }
          ...
          <div className="row">
            <div className="form-group col-md-3">
              ...
              <MultiSelect
                ...
                className="custom-select required"
                onChange={(selectedOptions) =>
                  setFormData({ ...formData, currency: selectedOptions.label })
                }
                required
              />
            </div>
            ...
            <div className="form-group col-md-3">
              ...
              <MultiSelect
                ...
                onChange={(selectedOptions) =>
                  setFormData({
                    ...formData,
                    salesmanager: selectedOptions.value,
                  })
                }
              />
            </div>
            <div className="form-group col-md-3">
              ...
              <MultiSelect
                ...
                onChange={(selectedOptions) =>
                  setFormData({
                    ...formData,
                    consultant: selectedOptions.value,
                  })
                }
                required
              />
...
export default CustomersAgentNew;
