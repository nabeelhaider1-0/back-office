...
const CustomersAgentSearchChangePassword = () => {
  ...
  <div className="panel-body">
    ...
    <div className="form-group col-md-12 mt-2">
      <button className="btn btn-dark btn-sm" type="button" name="b1" value="SUBMIT" >
...
export default CustomersAgentSearchChangePassword;