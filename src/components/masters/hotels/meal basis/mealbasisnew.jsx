...
const MastersHotelMealBasisNew = () => {
    ...
    if (isSuccessfull) {
      try {
        ...
        if (response.data.statusCode === 200) {
          SuccessApiToast("Room/Meal Added Successfully");

          navigate(Constants.URLConstants.MASTERSHOTELSMEALBASISSEARCH);
        }
      } catch (error) {
        ErrorApiAlert("Error Adding Room/Meal Basis");
      }
    }
  };
  return (
...
export default MastersHotelMealBasisNew;
