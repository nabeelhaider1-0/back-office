...
const MastersSuppliementsHotelNew = () => {
    ...
    if (isSuccessfull) {
      try {
        ...
        if (response.data.statusCode === 200) {
          SuccessApiToast("Supplement Added Successfully");

          navigate(Constants.URLConstants.MASTERSSUPPLIEMENTSHOTELSEARCH);
        }
      } catch (error) {
        ErrorApiAlert("Error Adding Supplement");
      }
    }
  };
  return (
    <>
      <Header2 title="ADD NEW SUPPLEMENT" linkText1="Add Supplement" />
...
export default MastersSuppliementsHotelNew;
