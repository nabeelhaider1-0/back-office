...
const HotelInventoryAppAllocation = ({ setShowHeaderAndMenuBar }) => {
            ...
            <header>
              <div className="row pt-0  pb-0 p-4">
                <div className="col-md-12">
                  ...
                  >
                    INVENTORY ALLOCATION AND RELEASE PERIOD
                  </h5>
                </div>
              </div>
            </header>
          ...
          >
            ...
            >
              <div className="panel-body form-group">
                <div className="row">
                  <div className="col-lg-3 col-md-4 col-sm-5 form-group">
                  ...
                  >
                    ...
                    <select
                      ...
                      className="selectpicker form-control form-control-sm form_element required ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                    >
                      {/* ngRepeat: x in Inventory track by $index */}
                      <option
                        value={26}
                        ng-repeat="x in Inventory track by $index"
                        className="ng-binding ng-scope"
                      >
                        Classic
                      </option>
                      {/* end ngRepeat: x in Inventory track by $index */}
                    </select>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <select
                      ...
                      className="selectpicker form-control form_element required ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                    >
                  ...
                  <div
                    className="col-lg-2 col-md-3 col-sm-4 form-group ng-hide"
                  ...
                  >
                    ...
                    <select
                      ...
                      className="selectpicker form_element show-menu-arrow form-control rateoption ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                    >
                      <option value data-hidden="true">
                        - Please Select -
                      </option>
                  ...
                  <div
                    className="col-lg-2 col-md-3 col-sm-4 form-group clearclass"
                    ng-show="ActionUpdateDisp"
                  >
                    <label>Enter Room Allocation</label>
                  ...
                  >
                    ...
                    <br />
                    <select
                      ng-change="FetchAllocationCalender('from_view_change_fit_package')"
                      ng-options="opt as opt.ratetypeName for opt in fitPackageRateTypeList"
                      className="selectpicker form_element show-menu-arrow form-control required ng-pristine ng-untouched ng-valid ng-not-empty bs-select-hidden"
                  ...
                  >
                    ...
                    <select
                      ...
                      className="selectpicker form_element show-menu-arrow form-control required ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                ...
                <div className="row">
                  <div
                    className="col-lg-3 col-md-3 col-sm-6 col-xs-9 form-group MultipleSeasonHideDates"
                    ng-show="ActionUpdateDisp"
                  >
                  ...
                  <div
                    className="width6Percent col-lg-1 col-md-1 col-sm-2 col-xs-3 form-group MultipleSeasonHideDates paddingZero autowidth"
                    ng-show="ActionUpdateDisp"
                  >
                    <label>&nbsp;</label>
                    <br />
                  ...
                  <div
                    className="col-lg-3 col-md-3 col-sm-3 form-group MultipleSeasonDates"
                    style={{ display: "none" }}
                    ng-show="ActionUpdateDisp"
                  >
                    <br />
                  ...
                  <div
                    className="col-lg-4 col-md-3 col-sm-3 paddingZero col-xs-12"
                    ng-show="multipleDatesSeason && ActionUpdateDisp"
                  >
                    <div className="col-md-12 Season_class">
                ...
                <div className="row" ng-show="ActionUpdateDisp">
                  <div className=" rateUnik room_chk">
                ...
                <div
                  className="row panel-footer1 ng-hide"
                  ng-show="ActionUpdateDisp && category.length>'0' && (Update.inventory=='YES' || Update.time_limit=='YES')"
                >
                  <div className="col-md-12 form-group">
                    <table
                      className="table table-responsive  text-center"
                      style={{ border: "1px solid #e4e5e7", marginTop: "10px" }}
                      width="100%"
                    >
                      <thead style={{ backgroundColor: "#f7f9fa" }}>
                        <tr className="bg-green">
                          ...
                          <th
                            ...
                            ng-show="Update.inventory=='YES'"
                          >
                            Inventory Allocation
                          </th>
                          <th
                            className="text-center ng-hide"
                            ng-show="Update.time_limit=='YES'"
                          >
                            Release Period
                          </th>
                        </tr>
                ...
                <div
                  ...
                  ng-show="category.length>'0' && (Update.inventory=='YES' || Update.time_limit=='YES') && ActionUpdateDisp"
                >
                ...
                <div
                  className="row"
                  ng-show="ActionUpdateDisp"
                  ng-hide="category.length > '0' && (Update.inventory=='YES' || Update.time_limit=='YES')"
                >
                  <div className="col-md-12">
                    <h5
                      className="mesID1 alert alert-danger text-left"
                      style={{
                    ...
                    >
                      * &nbsp; Select Inventory Room Category. &nbsp; | &nbsp;*
                      &nbsp; Select Inventory Allocation Or Release Period
                    </h5>
                  </div>
                </div>
                                          ...
                                          <tbody className="bg-white">
                                            <tr>
                                              ...
                                              <td className="fc-event-container">
                                                <Link className="fc-day-grid-event fc-event fc-start fc-end">
                                                  <div
                                                    id="invertory_box_2023-9-1"
                                                    className="fc-unthemed fc-today"
                                                  >
                                                    <div className="input-group input-group-sm pull-left inventory form-group1 widthforelementsincalendar">
                                                      <span className="input-group-addon customheight">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="form-control customheight inventory_ inventory__"
                                                        name="available[2023-9-1]"
                                                        placeholder="Available Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      <span className="input-group-addon customheight">
                                                      ...
                                                      <input
                                                        ...
                                                        onkeyup="this.value=this.value.replace(/[^0-9]/,'')"
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-1]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-2]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-3]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-4]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-5]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-6]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-7]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-8]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-9]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-10]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-11]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-12]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-13]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-14]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-15]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-16]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-17]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-18]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-19]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-20]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-21]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-22]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-23]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-24]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-25]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-26]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-27]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-28]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-29]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
                                                  ...
                                                  >
                                                    ...
                                                    <div className="input-group input-group-sm pull-left releaseperiod form-group1 widthforelementsincalendar">
                                                      ...
                                                      <input
                                                        ...
                                                        maxLength={4}
                                                        className="calenderreleaseperiod form-control customheight consumed_inventory_ consumed_inventory__"
                                                        name="consumed_inventory[2023-9-30]"
                                                        placeholder="Consumed Inventory"
                                                        aria-describedby="basic-addon1"
                                                      />
                                                    </div>
...
export default HotelInventoryAppAllocation;
