...
const HotelInventoryAppContracts = ({ setShowHeaderAndMenuBar }) => {
        ...
        <div>
          ...
          >
            <div className="blue-box1 mt-3">
              <div className="row">
                <div className="col-md-2 mt-2">
                  <div className="labelTitle2">MANAGE CONTRACTS FOR</div>
                </div>
            ...
            <form className="mt-4" style={{ paddingTop: "12px" }}>
              <div className="panel-body" data-ng-init="fn_load()">
                <div className="gapBigMe">
                  <div className="row">
                    <div className="col-md-3 col-sm-6 form-group">
                      ...
                      <input
                        ...
                        type="text"
                        ng-model="contract_name"
                      />
                    </div>
                    <div className="col-md-3 col-sm-6 form-group">
                      <label>Dates</label>
                      <div className="input-group" id="datePick">
                        <input
                          name="date1"
                          className="form-control form_element required ng-pristine ng-untouched ng-valid ng-empty"
                          ng-model="from_date"
                    ...
                    <div className="col-md-2 col-sm-4 form-group">
                      ...
                      {/* tooltips: */}
                      <label
                        className="btn upload-btn ng-scope"
                        htmlFor="file-upload"
                      >
                      ...
                      {/* tooltips: */}
                      <button
                        className="btn btn-sm  btn-success ng-scope"
                        type="button"
                        ng-click="insert_contract()"
                        style={{ marginTop: "-6px" }}
                      >
                    ...
                    <div className="col-md-1 col-sm-4 ortextMobile">
                      <label>&nbsp;</label>
                      <br />
                      <h4>OR</h4>
                    </div>
                    <div className="col-md-3 col-sm-4 ">
                      ...
                      <br />
                      <input
                        className="form-control selectpicker formTable ng-pristine ng-untouched ng-valid ng-empty"
                        ng-focus="search_icon = true"
                        ng-blur="search_icon = false"
                        placeholder="Search by contract name"
                        ng-model="contract"
                      />
                      <span ng-hide="search_icon">
                        <i
                          className="fa fa-search pull-right search_icon"
                          aria-hidden="true"
                          style={{
                            float: "right",
                            marginTop: "-22px",
                    ...
                    >
                      <thead>
                        <tr className="bg-green">
                          ...
                          <th className="text-center">Contract Dates</th>
                          <th className="text-center">ACTION</th>
                        </tr>
                      </thead>
                      <tbody className="bg-white">
                        {/* ngRepeat: x in aServiceData.aContractDetails.aResult | filter:contract */}
                        <tr
                          ng-show="aServiceData.aContractDetails.aResult.length==0"
                          className
                        >
                          <td colSpan={3}>
                  ...
                  >
                    <div className="modal-dialog ">
                      <div className="modal-content">
                        ...
                        <div className="modal-body raw model_height1">
                          <div className="text-center">
                            <h4>
                              <i className="fa fa-edit" /> VIEW DETAILS
                            </h4>
                          </div>
                          <hr />
                          <fieldset className="form-group col-md-12">
                            <label htmlFor="contract-name" className="col-md-6">
                              Contract Name
                              <span>:</span>
                            </label>
                            <span className="col-md-5 ng-binding">
                              {/*/span*/}
                            </span>
                          </fieldset>
                          <fieldset className="form-group col-md-12">
                            <label htmlFor="from-date" className="col-md-6">
                              From Date
                              <span>:</span>
                            </label>
                            <span className="col-md-5 ng-binding" />
                          ...
                          <fieldset className="form-group col-md-12">
                            <label htmlFor="to-date" className="col-md-6">
                              To Date
                              <span>:</span>
                            </label>
                            <span className="col-md-5 ng-binding" />
                          ...
                          <fieldset className="form-group col-md-12">
                            <label htmlFor="Supplier-id" className="col-md-6">
                              file
                              <span>:</span>
                            </label>
                            <span className="col-md-5">
                              <Link
                                className="btn btn-md w-xs btn-success"
                                type="button"
                                target="_self"
                                to
                                download
                                ng-click="fileDownload()"
                              >
                  ...
                  >
                    <div className="modal-dialog modal-lg">
                      <div className="modal-content">
                        <div className="color-line" />
                        <div className="modal-body raw model_height">
                          <div className="text-center">
                            <h4>
                          ...
                          <div className="text-center col-md-12">
                            <button
                              ...
                              ng-click="edit_contract(xvalue, '1')"
                            >
                              SUBMIT
                            </button>
                          </div>
...
export default HotelInventoryAppContracts;
