...
const HotelInventoryAppDeleteRates = ({ setShowHeaderAndMenuBar }) => {
            ...
            <div className="blue-box1 mt-3">
              <div className="row">
                <div className="col-md-2 mt-2">
                  <div className="labelTitle2">Delete Rates FOR</div>
                </div>
                      ...
                      <table className="table table-bordered  deleteratetable">
                        <thead>
                          <tr className="h-bg-navy-blue fontWhite">
                            ...
                            <th
                              ng-show="ExcludeNationality && !SpoRatesDelete"
                              className
                            >
                              Exclude Nationality
                            </th>
                        ...
                        <tbody className="bg-white">
                          <tr>
                            ...
                            <td
                              className="text-center width15Percent"
                              ng-show="ExcludeNationality && !SpoRatesDelete"
                            >
                              <select
                                data-actions-box="true"
                                ...
                                className="selectpicker show-menu-arrow form-control form-control-sm form_element ng-pristine ng-untouched ng-valid bs-select-hidden ng-empty"
                              >
                                <option value data-hidden="true">
                                  - Please Select -
                                </option>
...
export default HotelInventoryAppDeleteRates;
