...
const HotelInventoryAppHotelSetting = ({ setShowHeaderAndMenuBar }) => {
      ...
      <div>
        ...
        <div>
          ...
          >
            <div className="blue-box1 mt-3">
              <div className="row">
                <div className="col-md-2 mt-2">
                  <div className="labelTitle2">MANAGE HOTEL SETTING</div>
                </div>
            ...
            <form
              className="mt-3"
              style={{ paddingTop: "497px", paddingBottom: "0px" }}
            >
              <div className="panel-body">
                <div className="gapBigMe">
                  <div className="border_1">
                    <div className="child-settings-box">
                      <div className="child-settings-grey">
                        <div className="child-settings-box-01">
                          <div className="child-settings-text01">
                            Weekend Days :
                          </div>
                        </div>
                        <div className="child-settings-box-NEW">
                          <div className="child-settings-box-02-inner2">
                            {/* ngRepeat: weekday in weekdays */}
                            <div
                              className="checkbox checkbox-success checkbox-inline ng-scope"
                            ...
                            >
                              <input
                                ...
                                className="weekend"
                                defaultValue={1}
                                ng-checked="checkweekDay($index + 1)"
                              />
                              <label htmlFor="Monday" className="ng-binding">
                                Monday
                              </label>
                            </div>
                            {/* end ngRepeat: weekday in weekdays */}
                            <div
                              className="checkbox checkbox-success checkbox-inline ng-scope"
                              ng-repeat="weekday in weekdays"
                            >
                              <input
                                ...
                                ng-checked="checkweekDay($index + 1)"
                              />
                              <label htmlFor="Tuesday" className="ng-binding">
                                Tuesday
                              </label>
                            </div>
                            {/* end ngRepeat: weekday in weekdays */}
                            ...
                            >
                              <input
                                ...
                                ng-checked="checkweekDay($index + 1)"
                              />
                              <label htmlFor="Wednesday" className="ng-binding">
                                Wednesday
                              </label>
                            </div>
                            {/* end ngRepeat: weekday in weekdays */}
                            ...
                            >
                              <input
                                ...
                                ng-checked="checkweekDay($index + 1)"
                              />
                              <label htmlFor="Thursday" className="ng-binding">
                                Thursday
                              </label>
                            </div>
                            {/* end ngRepeat: weekday in weekdays */}
                            ...
                            >
                              <input
                                ...
                                ng-checked="checkweekDay($index + 1)"
                              />
                              <label htmlFor="Friday" className="ng-binding">
                                Friday
                              </label>
                            </div>
                            {/* end ngRepeat: weekday in weekdays */}
                            ...
                            >
                              ...
                              />
                              <label htmlFor="Saturday" className="ng-binding">
                                Saturday
                              </label>
                            </div>
                            {/* end ngRepeat: weekday in weekdays */}
                            ...
                            >
                              <input
                                ...
                                defaultChecked="checked"
                              />
                              <label htmlFor="Sunday" className="ng-binding">
                                Sunday
                              </label>
                            </div>
                            {/* end ngRepeat: weekday in weekdays */}
                      ...
                      <div
                        className="child-settings-grey ng-hide"
                        ng-show="property.room_rates_applicable_tax"
                      >
                        <div className="applicable_tax">
                          <div className="child-settings-box-21">
                            <div className="child-settings-text01">
                              Tax Applicable{" "}
                              <i
                                className="fa fa-info-circle"
                                title="Select to apply tax to total rate"
                              />
                            </div>
                          </div>
                          <div className="child-settings-box-applicable_tax">
                            <div className="child-settings-box-02-inner2">
                              <div className="checkbox checkbox-success checkbox-inline">
                                <input
                                  type="checkbox"
                                  id="is_applicable_tax"
                                  ng-checked="setApplicableTax(property.is_applicable_tax)"
                                />
                                <label htmlFor="is_applicable_tax">Yes</label>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div
                        className="child-settings-grey"
                        ng-show="property.channel_manager"
                      >
                        <div className="applicable_tax">
                          <div className="child-settings-box-21">
                            <div className="child-settings-text01">
                              ...
                              <i
                                className="fa fa-info-circle"
                                title="(Selecting / Unselecting channel manager will map / unmap room class for channel manager mapping.)"
                              />
                            </div>
                          </div>
                          <div className="child-settings-box-applicable_tax">
                            <div className="child-settings-box-22">
                              <select
                                data-live-search="true"
                                ...
                                ng-model="sel_channel_manager"
                              >
                                <option value>Select Channel Manager</option>
                                {/* ngRepeat: (channelManagerId, channelManagerName) in property.channel_manager_list track by $index */}
                                <option
                                  value="hotelrunner"
                                  ng-repeat="(channelManagerId, channelManagerName) in property.channel_manager_list track by $index"
                                  className="ng-binding ng-scope"
                                >
                                  hotelrunner
                                </option>
                                {/* end ngRepeat: (channelManagerId, channelManagerName) in property.channel_manager_list track by $index */}
                                <option
                                  value="travelclick"
                                  ng-repeat="(channelManagerId, channelManagerName) in property.channel_manager_list track by $index"
                                  className="ng-binding ng-scope"
                      ...
                      <div className="child-settings-grey">
                        <div className="child-settings-limit-box">
                          <div className="child-settings-limit-box01">
                            <div className="child-settings-box-21">
                              <div className="child-settings-text01">
                                Infant Lower Limit :
                              </div>
                            ...
                            <div className="child-settings-box-22">
                              <input
                                id="infant_lower_limit"
                                className="dynamic form-control form-control-sm age ng-pristine ng-untouched ng-valid ng-not-empty"
                                type="text"
                                ng-model="property.infant_lower_limit"
                                ng-init={0}
                                disabled
                              />
                            </div>
                            <div className="child-settings-box-23">
                              <div className="child-settings-text02">Yrs.</div>
                            </div>
                          </div>
                          <div className="child-settings-limit-box01">
                            <div className="child-settings-box-21">
                            ...
                            <div className="child-settings-box-22">
                              <select
                                id="infant_upper_limit"
                                data-container="body"
                                className="selectpicker show-menu-arrow form-control form-control-sm age ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                                ng-model="property.infant_upper_limit"
                                ng-change="setNewRange('tiny')"
                              >
                                <option value>select</option>
                                {/* ngRepeat: x in infant */}
                                <option
                                  value={1}
                                  ng-repeat="x in infant"
                                  className="ng-binding ng-scope"
                                >
                                  1
                                </option>
                                {/* end ngRepeat: x in infant */}
                                <option
                                  value={2}
                                  ng-repeat="x in infant"
                                  className="ng-binding ng-scope"
                      ...
                      <div className="child-settings-white">
                        <div className="child-settings-limit-box">
                          <div className="child-settings-limit-box01">
                            <div className="child-settings-box-21">
                              <div className="child-settings-text01">
                                Child Range 1 Lower Limit :
                              </div>
                            </div>
                            <div className="child-settings-box-22">
                              <input
                                id="tiny_child_lower_limit"
                                className="dynamic form-control form-control-sm age ng-pristine ng-untouched ng-valid ng-empty"
                                ng-model="property.tiny_child_lower_limit"
                                type="text"
                                disabled
                              />
                            </div>
                          ...
                          <div className="child-settings-limit-box01">
                            <div className="child-settings-box-21">
                              <div className="child-settings-text01">
                                Child Range 1 Upper Limit :
                              </div>
                            </div>
                            <div className="child-settings-box-22">
                              <select
                                id="tiny_child_upper_limit"
                                data-container="body"
                                className="selectpicker show-menu-arrow form-control form-control-sm age ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                                ng-model="property.tiny_child_upper_limit"
                                ng-change="setNewRange('child')"
                              >
                                <option value>select</option>
                                {/* ngRepeat: x in tiny */}
                              </select>
                      ...
                      <div className="child-settings-grey">
                        <div className="child-settings-limit-box">
                          <div className="child-settings-limit-box01">
                            <div className="child-settings-box-21">
                              <div className="child-settings-text01">
                                Child Range 2 Lower Limit :
                              </div>
                            </div>
                            <div className="child-settings-box-22">
                              <input
                                id="child_lower_limit"
                                className="dynamic form-control form-control-sm age ng-pristine ng-untouched ng-valid ng-empty"
                                ng-model="property.child_lower_limit"
                                type="text"
                                disabled
                              />
                            </div>
                          ...
                          <div className="child-settings-limit-box01">
                            <div className="child-settings-box-21">
                              <div className="child-settings-text01">
                                Child Range 2 Upper Limit :
                              </div>
                            </div>
                            <div className="child-settings-box-22">
                              <select
                                id="child_upper_limit"
                                data-container="body"
                                className="selectpicker show-menu-arrow form-control form-control-sm age ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                                ng-model="property.child_upper_limit"
                                ng-change="setNewRange('teen')"
                              >
                                <option value>select</option>
                                {/* ngRepeat: x in child */}
                              </select>
                      ...
                      <div className="child-settings-white">
                        <div className="child-settings-limit-box">
                          <div className="child-settings-limit-box01">
                            <div className="child-settings-box-21">
                              <div className="child-settings-text01">
                                Child Range 3 Lower Limit :
                              </div>
                            </div>
                            <div className="child-settings-box-22">
                              <input
                                id="teen_child_lower_limit"
                                className="dynamic form-control form-control-sm age ng-pristine ng-untouched ng-valid ng-empty"
                                ng-model="property.teen_child_lower_limit"
                                type="text"
                                disabled
                              />
                            </div>
                          ...
                          <div className="child-settings-limit-box01">
                            <div className="child-settings-box-21">
                              <div className="child-settings-text01">
                                Child Range 3 Upper Limit :
                              </div>
                            </div>
                            <div className="child-settings-box-22">
                              <select
                                id="teen_child_upper_limit"
                                data-container="body"
                                className="selectpicker show-menu-arrow form-control form-control-sm age ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                                ng-model="property.teen_child_upper_limit"
                              >
                                <option value>select</option>
                                {/* ngRepeat: x in teen */}
                              </select>
                      ...
                      <div
                        className="child-settings-grey"
                        ng-show="property.release_period_section"
                      >
                        <div className="child-settings-limit-box">
                          <div className="hotel-release-period-settings-limit">
                            <div className="child-settings-box-21">
                              <div className="child-settings-text01">
                                Release Period (Hrs:Min)
                                <i
                                  className="fa fa-info-circle"
                                  title="If checkin date and booking date is same or if release period duartion is less then hotel will not be displayed in listing and release period will be calculated from the time."
                                />
                              </div>
                            </div>
                            <div className="child-settings-box-22">
                              <select
                                data-live-search="true"
                                ng-model="selected_release_hrs"
                                id="release_sel_hrs"
                                className="selectpicker form-control form-control-sm show-menu-arrow ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                              >
                                <option value>Select Hour</option>
                                {/* ngRepeat: x in CreateTimeRange(24) track by $index */}
                                <option
                                  value={0}
                                  ng-repeat="x in CreateTimeRange(24) track by $index"
                                  className="ng-binding ng-scope"
                                >
                                  00
                                </option>
                                {/* end ngRepeat: x in CreateTimeRange(24) track by $index */}
                                <option
                                  value={1}
                                  ng-repeat="x in CreateTimeRange(24) track by $index"
                                  className="ng-binding ng-scope"
                            ...
                            <div className="child-settings-box-22">
                              <select
                                data-live-search="true"
                                ng-model="selected_release_mins"
                                id="release_sel_mins"
                                className="selectpicker form-control form-control-sm show-menu-arrow ng-pristine ng-untouched ng-valid ng-empty bs-select-hidden"
                              >
                                <option value>Select Minutes</option>
                                {/* ngRepeat: x in CreateTimeRange(60) track by $index */}
                                <option
                                  value={0}
                                  ng-repeat="x in CreateTimeRange(60) track by $index"
                                  className="ng-binding ng-scope"
                                >
                                  00
                                </option>
                                {/* end ngRepeat: x in CreateTimeRange(60) track by $index */}
                                <option
                                  value={1}
                                  ng-repeat="x in CreateTimeRange(60) track by $index"
                                  className="ng-binding ng-scope"
                            ...
                            <div className="child-settings-box-22">
                              <select
                                data-live-search="true"
                                className="selectpicker show-menu-arrow form-control form-control-sm ng-pristine ng-untouched ng-valid ng-not-empty bs-select-hidden"
                                ng-model="selected_timezone"
                                id="sel_timezone"
                              >
                                <option value>Select Timezone</option>
                                {/* ngRepeat: (timezone, timezoneVal) in property.timeZone track by $index */}
                                <option
                                  value={0}
                                  ng-repeat="(timezone, timezoneVal) in property.timeZone track by $index"
                                  className="ng-binding ng-scope"
                                  selected
                                >
                                  GMT +0:00 Hours (10:52 AM)
                                </option>
                                {/* end ngRepeat: (timezone, timezoneVal) in property.timeZone track by $index */}
                                <option
                                  value={1}
                                  ng-repeat="(timezone, timezoneVal) in property.timeZone track by $index"
                                  className="ng-binding ng-scope"
                                >
                                  GMT +1:00 Hours (11:52 AM)
                                </option>
                                {/* end ngRepeat: (timezone, timezoneVal) in property.timeZone track by $index */}
                                <option
                                  value={2}
                      ...
                      <div className="child-settings-footer">
                        <center>
                          <button
                            type="button"
...
export default HotelInventoryAppHotelSetting;
