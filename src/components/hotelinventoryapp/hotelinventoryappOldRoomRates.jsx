...
const HotelInventoryAppOldRoomRates = ({ setShowHeaderAndMenuBar }) => {
    ...
    <>
      <div>
        ...
        <div>
          ...
          >
            <div className="blue-box1 mt-2">
              <div className="row">
                <div
                  className="labelTitle3 ng-binding"
                  style={{ paddingLeft: "23px" }}
                >
                  {" "}
                  Old Room Rates For Alaaddin Hotel
                </div>
              </div>
            </div>
            <form>
              <div className="panel-body">
                ...
                <div className="row mt-2">
                  ...
                  <div
                    className="col-md-2 col-sm-4  col-xs-12 form-group customWidthTariff ng-hide"
...
export default HotelInventoryAppOldRoomRates;
