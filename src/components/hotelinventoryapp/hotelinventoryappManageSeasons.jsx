...
const HotelInventoryAppManageSeasons = ({ setShowHeaderAndMenuBar }) => {
              ...
              <div className="panel-body ">
                <div className="gapBigMe">
                  <div className="border_1">
                    <div className="row">
                      <div className="form-group col-md-2 col-sm-3 col-xs-12 zindx">
                        <label>Add New Season</label>
                        <input
                          type="text"
                          className="form-control form_element form-control-sm required ng-pristine ng-untouched ng-valid ng-empty"
                          ng-model="season_name"
                        />
                      </div>
                      <div className="col-md-4 col-sm-5 form-group MobileFix">
                        <label>Date</label>
                        <div
                          id="datePicks"
                        ...
                        >
                          ...
                          <div
                            className="form-group col-md-2 col-sm-2"
                            ng-show="multipleDatesSeason"
                          >
                            <div
                        ...
                        <div
                          id="datePick"
                          className="input-group date input-daterange ng-hide"
                      ...
                      <div className="pull-right rateUnik">
                        <label>&nbsp;</label>
                        <button
                          className="btn btn-sm  btn-success topmargin"
                          type="button"
                          ng-click="insert_season()"
                        >
                          Add Season
                        </button>
                      </div>
                      ...
                      <div
                        className="table-responsive manage_season_table"
                        id="step6"
                      >
                        <table
                        ...
                        >
                          <thead
                            ng-show="aServiceData.seasonList.length!=0"
                            className="thead_season ng-hide"
                          >
                            <tr>
                          ...
                          <tbody className="bg-white">
                            {/* ngRepeat: x in  aServiceData.seasonList */}
                          </tbody>
                        </table>
                      </div>
                    </div>
                    ...
                    <div className="modal-dialog modal-lg">
                      <div className="modal-content">
                        ...
                        <div className="modal-body raw">
                          ...
                          <hr />
                          <fieldset className="form-group col-md-6 col-sm-6">
                            ...
                            <input
                              type="text"
                              className="form-control ng-pristine ng-untouched ng-valid ng-empty"
                              ng-model="edit.season_name"
                            />
                          </fieldset>
                          <fieldset className="form-group col-md-6 col-sm-6">
                            <label htmlFor="from-date">From Date :</label>
                            <input
                              ng-disabled="multipleDatesSeason"
                              type="text"
                              className="form-control ng-pristine ng-untouched ng-valid ng-empty"
                              id="from_edit"
                              ng-model="edit.from_date"
                              date="dd-MM-yyyy"
                              disabled="disabled"
                            />
                          </fieldset>
                          <fieldset className="form-group col-md-6 col-sm-6">
                            ...
                            <input
                              ...
                              className="form-control ng-pristine ng-untouched ng-valid ng-empty"
                              id="to_edit"
                              ng-model="edit.to_date"
                              date="dd-MM-yyyy"
                              disabled="disabled"
                            />
                          </fieldset>
                          <fieldset className="col-md-6 col-sm-6 form-group">
                            <label>Remark(Optional)</label>
                            <textarea
                              className="form-control ng-pristine ng-untouched ng-valid ng-empty"
                              rows={1}
                              ng-model="edit.remark"
                              defaultValue={""}
                            />
                          </fieldset>
                          <input
...
export default HotelInventoryAppManageSeasons;
