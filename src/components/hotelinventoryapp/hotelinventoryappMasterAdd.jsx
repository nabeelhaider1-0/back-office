...
const HotelInventoryAppMasterAdd = ({ setShowHeaderAndMenuBar }) => {
              ...
              <div className="panel-body">
                <div className="row">
                  <div className="col-md-2 col-sm-6">
                    <label className="tooltipIndex">
                      Inventory Class
                      <i className="fa fa-info-circle" />
                    </label>
                    <input
                      title="Inventory Room Class"
                      placeholder="Inventory Room"
                      className="form-control form-control-sm form_element required ui-autocomplete-input ng-pristine ng-untouched ng-valid ng-empty"
                      type="text"
                      id="inventory_room_input"
                      ng-model="inventory_room_name"
                      autoComplete="off"
                    />
                    <input type="hidden" id="inventory_room_category" />
                  </div>
                  <div className="col-md-2 col-sm-6">
                ...
                <br />
                <div className="panel-body1 table-responsive border-green">
                  <table className="table table-responsive  table-bordered ">
                    <thead>
                      <tr style={{ background: "#fff" }}>
                        <td style={{ width: "25%" }}>Occupancy</td>
                        <td style={{ width: "31%" }}>No. of Child</td>
                        <td style={{ width: "31%" }}>No. of Extrabed</td>
                        <td style={{ width: "25%" }}>
                    ...
                    <tbody className="bg-white">
                      ...
                      >
                        ...
                        <input
                          type="hidden"
                          name="room_type_name[1]"
                          defaultValue="Single"
                        />
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input id="room_type_sel_1" type="checkbox" />
                            <label
                              htmlFor="checkboxaddnr"
                        ...
                        <td width="25%">
                          <input
                            ...
                            className="form-control form_element ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength"
                            type="text"
                            size={1}
                            maxLength={1}
                            data-toggle="tooltip"
                        ...
                        <td width="25%">
                          <input
                            title="No of Extrabed"
                            name="no_of_extrabed[1]"
                            placeholder="No of Extrabed"
                            className="form-control form_element ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength"
                            type="text"
                            size={1}
                            maxLength={1}
                            data-toggle="tooltip"
                            data-placement="top"
                            ng-model="NoOfExtrabed"
                            numbers-only
                          />
                        </td>
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input type="checkbox" id="non_refundable_1" />
                            <label htmlFor="checkboxaddnr">
                              Non Refundable
                            </label>
                          </div>
                        </td>
                      ...
                      >
                        ...
                        <input
                          type="hidden"
                          name="room_type_name[2]"
                          defaultValue="Double"
                        />
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input id="room_type_sel_2" type="checkbox" />
                            <label
                              htmlFor="checkboxaddnr"
                              className="ng-binding"
                            >
                        ...
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input type="checkbox" id="non_refundable_2" />
                            <label htmlFor="checkboxaddnr">
                              Non Refundable
                            </label>
                          </div>
                      ...
                      >
                        ...
                        <input
                          type="hidden"
                          name="room_type_name[6]"
                          defaultValue="Triple"
                        />
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input id="room_type_sel_6" type="checkbox" />
                            <label
                              htmlFor="checkboxaddnr"
                              className="ng-binding"
                            >
                        ...
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input type="checkbox" id="non_refundable_6" />
                            <label htmlFor="checkboxaddnr">
                              Non Refundable
                            </label>
                          </div>
                      ...
                      >
                        ...
                        <input
                          type="hidden"
                          name="room_type_name[8]"
                          defaultValue="Quad"
                        />
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input id="room_type_sel_8" type="checkbox" />
                            <label
                              htmlFor="checkboxaddnr"
                              className="ng-binding"
                            >
                        ...
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input type="checkbox" id="non_refundable_8" />
                            <label htmlFor="checkboxaddnr">
                              Non Refundable
                            </label>
                          </div>
                      ...
                      >
                        ...
                        <input
                          type="hidden"
                          name="room_type_name[23]"
                          defaultValue="One Club"
                        />
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input id="room_type_sel_23" type="checkbox" />
                            <label
                              htmlFor="checkboxaddnr"
                              className="ng-binding"
                            >
                        ...
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input type="checkbox" id="non_refundable_23" />
                            <label htmlFor="checkboxaddnr">
                              Non Refundable
                            </label>
                          </div>
                      ...
                      >
                        ...
                        <input
                          type="hidden"
                          name="room_type_name[27]"
                          defaultValue="Two Club"
                        />
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input id="room_type_sel_27" type="checkbox" />
                            <label
                              htmlFor="checkboxaddnr"
                              className="ng-binding"
                            >
                        ...
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input type="checkbox" id="non_refundable_27" />
                            <label htmlFor="checkboxaddnr">
                              Non Refundable
                            </label>
                          </div>
                      ...
                      >
                        ...
                        <input
                          type="hidden"
                          name="room_type_name[31]"
                          defaultValue="Three Club"
                        />
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input id="room_type_sel_31" type="checkbox" />
                            <label
                              htmlFor="checkboxaddnr"
                              className="ng-binding"
                            >
                        ...
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input type="checkbox" id="non_refundable_31" />
                            <label htmlFor="checkboxaddnr">
                              Non Refundable
                            </label>
                          </div>
                      ...
                      >
                        ...
                        <input
                          type="hidden"
                          name="room_type_name[35]"
                          defaultValue="Four Club"
                        />
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input id="room_type_sel_35" type="checkbox" />
                            <label
                              htmlFor="checkboxaddnr"
                              className="ng-binding"
                            >
                        ...
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input type="checkbox" id="non_refundable_35" />
                            <label htmlFor="checkboxaddnr">
                              Non Refundable
                            </label>
                          </div>
                      ...
                      >
                        ...
                        <input
                          type="hidden"
                          name="room_type_name[39]"
                          defaultValue="Five Club"
                        />
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input id="room_type_sel_39" type="checkbox" />
                            <label
                              htmlFor="checkboxaddnr"
                              className="ng-binding"
                            >
                        ...
                        <td width="25%">
                          <div className="checkbox checkbox-success">
                            <input type="checkbox" id="non_refundable_39" />
                            <label htmlFor="checkboxaddnr">
                              Non Refundable
                            </label>
                          </div>
...
export default HotelInventoryAppMasterAdd;
