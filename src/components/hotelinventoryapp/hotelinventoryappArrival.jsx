...
const HotelInventoryAppArrival = ({ setShowHeaderAndMenuBar }) => {
                  ...
                  <div id="Arrivalbox">
                    <div className="cities-green headTitle">
                      <div className="row">
                        ...
                        <div className="col-md-3 col-sm-6 col-xs-10 mar_to10 pull-right mobileFixes01 mt-2">
                          <div className="arrivals-box-02-11 label_wh_grn width10 ng-binding">
                            0
                          </div>
                          <div className="arrivals-box-02-12 label_grn_wh width10 ng-binding">
                            Arrivals Today
                          </div>
                          <div className="arrivals-box-02-13 width10">
                            <img src={bedico} alt="bell" />
                          </div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="hotel-main-box" style={{ height: "222px" }}>
                    <div className="row">
                      <div className="col-md-12">
                        <div
...
export default HotelInventoryAppArrival;
