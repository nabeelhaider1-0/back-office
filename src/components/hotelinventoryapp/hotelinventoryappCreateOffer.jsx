...
const HotelInventoryAppCreateOffer = ({ setShowHeaderAndMenuBar }) => {
            ...
            <div className="blue-box1 mt-3">
              <div className="row">
                <div className="col-md-3 mt-2">
                  <div className="labelTitle2">ADD NEW OFFERS / DISCOUNTS</div>
                </div>
              </div>
            </div>
            <form
            ...
            >
              <div className="panel-body">
                <div className="row">
                  ...
                  <div
                    className="col-md-2 col-sm-3 form-group"
                ...
                <div className="row">
                  ...
                  <div className="col-md-2 col-sm-4 mar_top15 col-xs-5 form-group">
                    ...
                    <div className=" form-group">
                      <div
                        className="input-group col-md-12 col-xs-12"
                ...
                <div className="panel-body" id="EBD_tab">
                  ...
                  <div className="row">
                    ...
                    <div
                      className="col-md-3 col-sm-4  col-xs-5  form-group"
                      ng-show="EBD_rateType=='Amount'"
                    >
                      ...
                      <span>
                        <select
                          ...
                          data-container="body"
                          data-live-search="true"
                          ng-model="EBD_currency"
                        >
                          <option value>Please Select</option>
                          {/* ngRepeat: x in currency */}
                          <option
                            value="AED"
                            ng-repeat="x in currency"
                            className="ng-binding ng-scope"
                          >
                            AED
                          </option>
                          {/* end ngRepeat: x in currency */}
                          <option
                            value="AUD"
                            ng-repeat="x in currency"
                            className="ng-binding ng-scope"
                        ...
                        >
                          ...
                          <tip className>
                            <tip-tip>
                              ...
                              Note : If Currency is not selected, Amount entered
                              in Discount field will apply as Percentage
                            </tip-tip>
                            <tip-arrow />
                          </tip>
                        </tooltip>
...
export default HotelInventoryAppCreateOffer;
