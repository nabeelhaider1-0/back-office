...
const HotelInventoryAppExpiringRates = ({ setShowHeaderAndMenuBar }) => {
              ...
              <div class="col-md-12">
                  <div class="menu-box">
                      <div class="menu-main-box">
                          <ul class="nav nav-pills">
                            ...
                            <li><Link to="rate.html">Rates</Link></li>
                            <li class="active"><Link to="contract.html">Contracts</Link></li>
                          </ul>
                      </div>            
                  </div>
              </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    <Link
                      className="pull-right back-button"
                  ...
                  <div id="Expirebox">
                    <div className="expiring-box headTitle">
                      ...
                      <span className="labelImg imgWid">
                        <img src="calenderIco.png" alt="cri" />
                      </span>
                    </div>
                        ...
                        >
                          ...
                          <div className="tab-content">
                            ...
                            >
                              ...
                              >
                                <tbody className="bg-white">
                                  {/* ngRepeat: x in expiringRatesDetails.todayExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.todayExpiring | limitTo:limit"
                                    className="ng-scope"
                                  >
                                    <td
                                      width="50%"
                                      className="ng-binding"
                                      style={{ paddingRight: "616px" }}
                                    >
                                      Classic Single{" "}
                                    </td>
                                    <td
                                      className="pull-right text-right ng-binding"
                                      width="50%"
                                    >
                                      Sep 02, 2023
                                    </td>
                                  </tr>
                                  {/* end ngRepeat: x in expiringRatesDetails.todayExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.todayExpiring | limitTo:limit"
                                    className="ng-scope"
                                  >
                                    <td width="50%" className="ng-binding">
                                      Classic Single{" "}
                                    </td>
                                    <td
                                      className="pull-right text-right ng-binding"
                            ...
                            >
                              ...
                              >
                                <tbody ng-init="limit=4">
                                  {/* ngRepeat: x in expiringRatesDetails.oneMonthExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.oneMonthExpiring | limitTo:limit"
                                    className="
                                                  ng-scope"
                                  >
                                    <td width="50%" className="ng-binding">
                                  ...
                                  {/* end ngRepeat: x in expiringRatesDetails.oneMonthExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.oneMonthExpiring | limitTo:limit"
                                    className="
                                                  ng-scope"
                            ...
                            >
                              ...
                              >
                                <tbody className="bg-white">
                                  {/* ngRepeat: x in expiringRatesDetails.threeMonthExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.threeMonthExpiring | limitTo:limit"
                                    className="
                                                  ng-scope"
                                  >
                                    <td width="50%" className="ng-binding">
                                  ...
                                  {/* end ngRepeat: x in expiringRatesDetails.threeMonthExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.threeMonthExpiring | limitTo:limit"
                                    className="
                                                  ng-scope"
                            ...
                            >
                              ...
                              >
                                <tbody className="bg-white">
                                  {/* ngRepeat: x in expiringRatesDetails.sixMonthExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.sixMonthExpiring | limitTo:limit"
                                    className="
                                                  ng-scope"
                                  >
                                    <td width="50%" className="ng-binding">
                                  ...
                                  {/* end ngRepeat: x in expiringRatesDetails.sixMonthExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.sixMonthExpiring | limitTo:limit"
                                    className="
                                                  ng-scope"
                            ...
                            >
                              ...
                              >
                                <tbody className="bg-white">
                                  {/* ngRepeat: x in expiringRatesDetails.oneYearExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.oneYearExpiring | limitTo:limit"
                                    className="
                                                  ng-scope"
                                  >
                                    <td width="50%" className="ng-binding">
                                  ...
                                  {/* end ngRepeat: x in expiringRatesDetails.oneYearExpiring | limitTo:limit */}
                                  <tr
                                    ng-repeat="x in expiringRatesDetails.oneYearExpiring | limitTo:limit"
                                    className="
                                                  ng-scope"
...
export default HotelInventoryAppExpiringRates;
