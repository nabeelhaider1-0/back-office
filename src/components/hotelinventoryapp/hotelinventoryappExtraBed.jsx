...
const HotelInventoryAppExtraBed = ({ setShowHeaderAndMenuBar }) => {
      ...
      <div>
        ...
        <div>
          ...
          >
              ...
              <div className="row">
                <div className="col-md-3 mt-2">
                  <div className="labelTitle2">
                    MANAGE CHILD RATES/EXTRABED FOR
                  </div>
                </div>
            ...
            <form className="mt-4" style={{ paddingTop: "12px" }}>
              <div className="panel-body">
                <div className="form-group col-md-12 col-xs-12">
                  <div className="btn-group text-center m-b-md">
                    <Link
                      className="btn btn-sm ng-pristine ng-untouched ng-valid ng-not-empty btn-primary"
                      ng-click="SetActionType('add_update')"
                      id="Actiontype_add_update"
                      ng-model="ActionType"
                      data-bs-toggle="tab"
                    >
                      Add/Update Extrabed Rates
                    </Link>
                    <Link
                ...
                <div className="extMarExtrabedRates">
                  <div
                    className="row"
                    ng-show="ageRanges.infant_lower_limit=='0'"
                    ng-hide="RoomClassModel==''"
                  >
                    <div className="col-lg-2 col-md-4 col-sm-6 col-xs-12 form-group">
                      <label>Room Category</label>
                      <select
                        data-live-search="true"
                        data-container="body"
                        id="roomClassExtrabed"
                        className="selectpicker show-menu-arrow form-control form_element form-control-sm required ng-pristine ng-untouched ng-valid bs-select-hidden ng-not-empty"
                        ng-change="GetExtrabedCapacity();"
                    ...
                    <div
                      className="col-lg-1 col-md-1 col-sm-1 col-xs-1 form-group Width10Plus"
                    ...
                    <div
                      className="col-lg-2 col-md-3 col-sm-4 col-xs-6 form-group Width13Plus"
                      ng-show="ActionUpdateDisp"
                    >
                      <label>Slot</label>
                      <br />
                    ...
                    <div
                      className="col-lg-2 col-md-3 col-sm-3 col-xs-6 form-group ng-hide"
                    ...
                    >
                      ...
                      <select
                        ...
                        data-live-search="true"
                      >
                        <option value="? object:184 ?" />
                        <option value>Select Package Type</option>
                        {/* ngRepeat: opt in fitPackageRateTypeList */}
                        <option
                          ng-repeat="opt in fitPackageRateTypeList"
                          value="no"
                          className="ng-binding ng-scope"
                        >
                          FIT RATE
                        </option>
                        {/* end ngRepeat: opt in fitPackageRateTypeList */}
                        <option
                          ng-repeat="opt in fitPackageRateTypeList"
                          value="yes"
                          className="ng-binding ng-scope"
                          ...
                          <ul className="dropdown-menu inner" role="menu">
                            ...
                            <li data-original-index={2}>
                              <Link
                                ...
                                data-tokens="null"
                              >
                                <span className="text">FIT RATE</span>
                                <span className="glyphicon glyphicon-ok check-mark" />
                              </Link>
                            </li>
                            <li data-original-index={3}>
                              <Link
                                ...
                                data-tokens="null"
                              >
                                <span className="text">PACKAGE RATE</span>
                                <span className="glyphicon glyphicon-ok check-mark" />
                              </Link>
                            </li>
                          </ul>
                    ...
                    <div
                      ng-show="fitPackageRateType && fitPackageRateSelected=='yes'"
                      className="col-lg-3 col-md-3 col-sm-3 col-xs-2 form-group ng-hide"
                    >
                      <label>&nbsp;</label>
                      <br />
                      <div
                      ...
                      >
                        <Link
                          ng-show="!ActionUpdateDisp"
                          ng-click="setExtrabedAllowed()"
                          id="allExtrabedAllowed"
                          className="btn btn-sm ng-hide"
                          data-bs-toggle="tab"
                        >
                          Both
                        </Link>
                        <Link
                          ng-click="setExtrabedAllowed('yes')"
                          id="extrabedAllowedYes"
                          className="btn btn-sm btn-primary"
                          data-bs-toggle="tab"
                        >
                          With Extrabed
                        ...
                        <Link
                          ng-click="setExtrabedAllowed('no')"
                          id="extrabedAllowedNo"
                  ...
                  >
                    <div
                      className="col-lg-3 col-md-5 col-sm-6 col-xs-12 form-group"
                      id="period"
                      ng-show="RatesByPeriod && ActionUpdateDisp"
                    >
                      <label>Period</label>
                      <div className="row">
                        <div className="MultiplePeriodClone col-lg-9 col-md-8 col-sm-8 col-xs-9">
                          <div
                            id="datePicks"
                        ...
                        >
                          <div
                            className="AddRemoveClone"
                            ng-show="RatesByPeriod"
                          >
                            <Link
                              className="btn btn-sm btn-primary"
                    ...
                    <div
                      className="col-lg-3 col-md-5 col-sm-6 col-xs-12 form-group ng-hide"
                      id="period"
                      ng-show="!ActionUpdateDisp"
                    >
                      <label>Period</label>
                      <div className="row">
                        <div className="col-lg-9 col-md-8 col-sm-8 col-xs-9">
                          <div
                            id="datePickerSearchExtrabed"
                            className="input-group-clone npadding"
                          >
                            <input
                              type="text"
                              defaultValue="period_search_from"
                              id="search_from_date"
                              name="search_from_date"
                              ng-model="search_from_date"
                              className="form-control date_range_picker_search_from ng-pristine ng-untouched ng-valid ng-not-empty"
                              date="dd-MM-yyyy"
                            />
                            <span className="input-group-addon">To</span>
                            <input
                              type="text"
                              defaultValue="period_search_to"
                              id="search_to_date"
                              name="search_to_date"
                              ng-model="search_to_date"
                              className="form-control date_range_picker_search_to ng-pristine ng-untouched ng-valid ng-not-empty"
                              date="dd-MM-yyyy"
                            />
                            <span
                              id="clear_search_id"
                              onclick="clearSearchDate(this)"
                              title="clear"
                              alt="clear"
                              className="input-group-addon"
                            >
                    ...
                    <div ng-hide="multipleDatesSeason" className="ng-hide">
                      <div
                        className="col-lg-3 col-md-2 col-sm-4 col-xs-12 form-group ng-hide"
                        id="season"
                        ng-show="RatesBySeason && ActionUpdateDisp"
                      >
                        <label>Season</label>
                        <select
                          data-live-search="true"
                          data-container="body"
                          className="selectpicker show-menu-arrow form-control form_element required ng-pristine ng-untouched ng-valid bs-select-hidden ng-empty"
                          ng-model="SeasonModel"
                        >
                          <option value>Please Select</option>
                          {/* ngRepeat: x in seasonlist */}
                        </select>
                        <div className="btn-group bootstrap-select show-menu-arrow form-control form_element required ng-pristine ng-untouched ng-valid ng-empty">
                          <button
                            type="button"
                            className="btn dropdown-toggle btn-default"
                            data-toggle="dropdown"
                    ...
                    <div
                      className="col-lg-3 col-md-2 col-sm-4 col-xs-12 form-group"
                      id="season"
                      ng-show="multipleDatesSeason && ActionUpdateDisp"
                    >
                      <div ng-show="RatesBySeason" className="ng-hide">
                        <label>Season</label>
                        <select
                          data-live-search="true"
                          data-container="body"
                    ...
                    <div
                      className="col-lg-3 col-md-2 col-sm-12 col-xs-12 form-group MultipleSeasonDates"
                      style={{ display: "none" }}
                      ng-show="ActionUpdateDisp"
                    >
                      <div ng-show="RatesBySeason" className="ng-hide">
                        <br />
                        <div className="row">
                          <div className="col-md-8 col-lg-12 col-sm-4 MultipleDatesClone">
                            <div
                              id="datePeriod_0"
                  ...
                  <div className="row ng-hide" ng-show="!ActionUpdateDisp">
                    <div className="col-md-12">
                      <div className="text-left form-group">
                        <button
                          type="button"
                          className="btn btn-sm w-xs btn-primary"
                          ng-click="FetchExtrabedRates();"
                        >
                          <h6>&nbsp;Search</h6>
                        </button>
                      </div>
                  ...
                  <div
                    ...
                    ng-show="ageRanges.infant_lower_limit=='0' && RoomClassModel!='' && ExtrabedCapacity!='0'"
                  >
                    <div className="col-md-12">
                      <div className="extrabed-box">
                        <div className="row">
                          <div className="col-md-12">
                            <div className="row">
                              ...
                              {/* ngRepeat: i in getNumber(ExtrabedCapacity) */}
                              <div
                                className="col-lg-3 col-sm-4 col-md-4 form-group ExtrabedRateVal ng-scope"
                                ng-repeat="i in getNumber(ExtrabedCapacity)"
                              >
                                <div className="form-inline m-b ExtrabedRates_1">
                                  <div className="checkbox checkbox-primary">
                                    <input
                                      onclick="ExtrabedAllow(this)"
                                      type="checkbox"
                                      name="ExtrabedAllowed[1]"
                                      className="styled styled-primary"
                                      id="ExtrabedAllowed_1"
                                    />
                                    <label>
                                      <span className="child-text ng-binding">
                                        &nbsp;Extrabed 1
                                      </span>
                                    </label>
                                  </div>
                              ...
                              {/* end ngRepeat: i in getNumber(ExtrabedCapacity) */}
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="extrabed-box">
                        <div className="row">
                          <div className="col-md-12">
                            <div className="row">
                              <div className="col-sm-2">
                                <div className="year-text ng-binding">
                                  Infant ( - ) Years
                                </div>
                              </div>
                              {/* ngRepeat: i in getNumber(ExtrabedCapacity) */}
                              ...
                              >
                                <div className="form-inline m-b ExtrabedRates_1">
                                  <span
                                    className="copy-text tbl_onRqt pull-right ng-hide"
                                    ng-show="i==1 && ExtrabedCapacity>1"
                                    ng-click="Copy('infant')"
                                  >
                                    Copy
                                  </span>
                                  <div className="checkbox checkbox-primary">
                                    <input
                                      type="checkbox"
                                      name="eRate[1][infant][checkbox]"
                                      onclick="return CheckboxSelected(this)"
                                      className="styled styled-primary"
                                      id="InfantRateCheckBox_1"
                                    />
                                    <label />
                                  </div>
                                  <span className="form-control input-group-addon input-box">
                                    <img
                                      src="images/missing-data/childico_orange.png"
                                      alt="cri"
                                    />
                                  </span>
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="InfantRateCheckBox_1 form-control add_marleft infant_WD ng-empty"
                                    name="eRate[1][infant][WD]"
                                    ng-model="infantWD"
                                    placeholder
                                    decimals-only
                                  />
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="InfantRateCheckBox_1 form-control infant_WE ng-empty ng-hide"
                                    name="eRate[1][infant][WE]"
                                    ng-model="infantWE"
                                    placeholder="WE"
                                    ng-show="enterRateFor!='ALL'"
                                    decimals-only
                                  />
                                </div>
                              </div>
                      ...
                      <div
                        className="extrabed-box ng-hide"
                        ng-show="ageRanges.tiny_child_lower_limit > 0"
                      >
                        <div className="row">
                          <div className="col-md-12">
                            <div className="row">
                              ...
                              >
                                <div className="form-inline m-b ExtrabedRates_1">
                                  ...
                                  <div className="checkbox checkbox-primary">
                                    <input
                                      type="checkbox"
                                      name="eRate[1][tiny][checkbox]"
                                      onclick="return CheckboxSelected(this)"
                                      className="styled styled-primary"
                                      id="TinyRateCheckBox_1"
                                    />
                                    <label />
                                  </div>
                                  <span className="form-control input-group-addon input-box">
                                    <img
                                      src="images/missing-data/childico_orangedark.png"
                                      alt="cri"
                                    />
                                  </span>
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="TinyRateCheckBox_1 form-control add_marleft tiny_WD ng-empty"
                                    name="eRate[1][tiny][WD]"
                                    ng-model="tinyWD"
                                    placeholder
                                    decimals-only
                                  />
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="TinyRateCheckBox_1 form-control tiny_WE ng-empty ng-hide"
                                    name="eRate[1][tiny][WE]"
                                    ng-model="tinyWE"
                                    placeholder="WE"
                                    ng-show="enterRateFor!='ALL'"
                                    decimals-only
                      ...
                      <div
                        className="extrabed-box ng-hide"
                        ng-show="ageRanges.child_lower_limit > 0"
                      >
                        <div className="row">
                          <div className="col-md-12">
                            <div className="row">
                              ...
                              >
                                <div className="form-inline m-b ExtrabedRates_1">
                                  ...
                                  <div className="checkbox checkbox-primary">
                                    <input
                                      type="checkbox"
                                      name="eRate[1][child][checkbox]"
                                      onclick="return CheckboxSelected(this)"
                                      className="styled styled-primary"
                                      id="ChildRateCheckBox_1"
                                    />
                                    <label />
                                  </div>
                                  <span className="form-control input-group-addon input-box">
                                    <img
                                      src="images/missing-data/childico_purple.png"
                                      alt="cri"
                                    />
                                  </span>
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="ChildRateCheckBox_1 form-control add_marleft child_WD ng-empty"
                                    name="eRate[1][child][WD]"
                                    ng-model="childWD"
                                    placeholder
                                    decimals-only
                                  />
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="ChildRateCheckBox_1 form-control child_WE ng-empty ng-hide"
                                    name="eRate[1][child][WE]"
                                    ng-model="childWE"
                                    placeholder="WE"
                                    ng-show="enterRateFor!='ALL'"
                                    decimals-only
                      ...
                      <div
                        className="extrabed-box ng-hide"
                        ng-show="ageRanges.teen_child_lower_limit > 0"
                      >
                        <div className="row">
                          <div className="col-md-12">
                            <div className="row">
                              ...
                              >
                                <div className="form-inline m-b ExtrabedRates_1">
                                  ...
                                  <div className="checkbox checkbox-primary">
                                    <input
                                      type="checkbox"
                                      name="eRate[1][teen][checkbox]"
                                      onclick="return CheckboxSelected(this)"
                                      className="styled styled-primary"
                                      id="TeenRateCheckBox_1"
                                    />
                                    <label />
                                  </div>
                                  <span className="form-control input-group-addon input-box">
                                    <img
                                      src="images/missing-data/childico_blue.png"
                                      alt="cri"
                                    />
                                  </span>
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="TeenRateCheckBox_1 form-control add_marleft teen_WD ng-empty"
                                    name="eRate[1][teen][WD]"
                                    ng-model="teenWD"
                                    placeholder
                                    decimals-only
                                  />
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="TeenRateCheckBox_1 form-control teen_WE ng-empty ng-hide"
                                    name="eRate[1][teen][WE]"
                                    ng-model="teenWE"
                                    placeholder="WE"
                                    ng-show="enterRateFor!='ALL'"
                                    decimals-only
                      ...
                      <div className="extrabed-box">
                        <div className="row">
                          <div className="col-md-12">
                            <div className="row">
                              <div className="col-sm-2">
                                <div className="year-text">Adult(s)</div>
                              </div>
                              {/* ngRepeat: i in getNumber(ExtrabedCapacity) */}
                              <div
                                className="ccol-lg-3 col-sm-4 col-md-4 form-group ExtrabedRateVal ng-scope"
                                ng-repeat="i in getNumber(ExtrabedCapacity)"
                              >
                                <div className="form-inline m-b ExtrabedRates_1">
                                  <span
                                  ...
                                  <div className="checkbox checkbox-primary">
                                    <input
                                      type="checkbox"
                                      name="eRate[1][adult][checkbox]"
                                      onclick="return CheckboxSelected(this)"
                                      className="styled styled-primary"
                                      id="AdultRateCheckBox_1"
                                    />
                                    <label />
                                  </div>
                                  <span className="form-control input-group-addon input-box">
                                    <img
                                      src="images/missing-data/maleIco_green.png"
                                      alt="cri"
                                    />
                                  </span>
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="AdultRateCheckBox_1 form-control add_marleft adult_WD ng-empty"
                                    name="eRate[1][adult][WD]"
                                    ng-model="adultWD"
                                    placeholder
                                    decimals-only
                                  />
                                  <input
                                    readOnly="readonly"
                                    type="text"
                                    className="AdultRateCheckBox_1 form-control adult_WE ng-empty ng-hide"
                                    name="eRate[1][adult][WE]"
                                    ng-model="adultWE"
                                    placeholder="WE"
                                    ng-show="enterRateFor!='ALL'"
                                    decimals-only
                      ...
                      <div className="extrabed-box">
                        <div className="row">
                          <div className="col-md-12">
                            <div className="row">
                              <div className="col-sm-2 cuswidth">
                                <div className="year-text">Notes</div>
                              </div>
                              {/* ngRepeat: i in getNumber(ExtrabedCapacity) */}
                              <div
                                className="col-lg-3 col-sm-4 col-md-4 form-group ExtrabedRateVal ng-scope"
                              ...
                              >
                                <div className="input-group m-b">
                                  <textarea
                                    type="text"
                                    className="form-control nresize"
                                    id="note_1"
                                    defaultValue={""}
                                  />
                                </div>
                  ...
                  <div
                    className="row ng-hide"
                    ng-show="ExtrabedCapacity=='0' && ActionUpdateDisp"
                  >
                    <div className="col-md-12">
                      <h5 className="mesID1 alert alert-danger text-center">
                        No Extrabed for This Room Category.
                      </h5>
                    </div>
                  </div>
                  <div
                    className="row ng-hide"
                    ng-show="RoomClassModel=='' && ActionUpdateDisp"
                  >
                    <div className="col-md-12">
                      <h5 className="mesID1 alert alert-danger text-center">
                        No Room Category added for this Hotel.
                      </h5>
                    </div>
                  </div>
                  <div
                    className="row"
                    ng-show="ageRanges.infant_lower_limit!='0' && ActionUpdateDisp"
                  >
                    <div className="col-md-12">
                      <h5 className="mesID1 alert alert-danger text-center">
                        Note - 1)May be No child/infant Age Ranges were defined.
                        Please Add child/infant age ranges to proceed further.
                        2) May Be No weekends were defined for this hotel.
                        Please Add weekends to proceed further.
                      </h5>
                    </div>
                  </div>
                  <div
                    className="row ng-hide"
                    ng-show="extrabedRate.length<='0' && !ActionUpdateDisp"
                  >
                    <div className="col-md-12">
                      <h5 className="mesID1 alert alert-danger text-center">
...
export default HotelInventoryAppExtraBed;
