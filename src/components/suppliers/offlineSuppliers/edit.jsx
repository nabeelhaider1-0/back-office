...
const OfflineSuppliersEdit = ({ data }) => {
  ...
  useEffect(() => {
    if (data && Object.keys(data).length > 0) {
      setFormData({
        ...
        editHotels: data.editHotels,
        editAdminRates: data.editAdminRates,
        VCC: data.VCC,
        taxRegistration: data.taxRegistration,
      });
      setEmails(data.email);
      setCancellationEmails(data.cancellationEmail);
      setReservationEmails(data.reservationEmail);
      document
        .querySelectorAll('input[type="checkbox"]')
        .forEach((checkbox) => {
          if (data.supplierType.includes(checkbox.value)) {
  ...
  const handleSupplierCheckboxChange = (e) => {
    ...
    if (isChecked) {
      ...
      setFormData((prevFormData) => ({
        ...prevFormData,
        supplierType: prevFormData.supplierType.filter(
          (type) => type !== checkboxValue
        ),
      }));
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.statusCode === 200) {
        SuccessApiToast("Offline Supplier Updated Successfully");
        navigate(Constants.URLConstants.OFFLINESUPPLIERSEARCH);
      } else {
        SimpleAlert("error", "Error", "Failed to Update Offline Supplier");
      }
    } catch (error) {
  ...
  const addEmailField = (event) => {
    ...
    if (emails.length < 5) {
      ...
      SimpleAlert(
        "warning",
        "",
        "Sorry, you can add a maximum of 5 emails only"
      );
    }
  };
                  ...
                  value={
                    iscityChanged === false
                      ? selectedCountry
                        ...
                        : ""
                      : selectedCountry
                      ? filterOptionsByLabel(cityOptions, selectedCity)
                      : ""
                  }
                  isSearchable
                        ...
                        {index === 0 && (
                          ...
                          >
                            <button
                              ...
                              id="plus"
                              onClick={(event) => addEmailField(event)}
                            ...
                            {emails.length > 1 && (
                              <button
                                className="input-group-addon"
                                id="minus"
                                onClick={(event) => removeEmailField(event)}
                              >
                                <i
                        ...
                        <div className="col-md-10" key={index}>
                          <div className="input-group">
                            <input
                              ...
                              value={email}
                              onChange={(e) =>
                                handleReservationEmailInputChange(index, e)
                              }
                              required
                              size="45"
                              maxLength="70"
                            ...
                            {index === 0 && (
                              ...
                              >
                                <button
                                  ...
                                  id="plus"
                                  onClick={(event) =>
                                    addReservationEmailField(event)
                                  }
                                  style={{ marginRight: "5px" }}
                                >
                                  <i
                                ...
                                {reservationemails.length > 1 && (
                                  <button
                                    ...
                                    id="minus"
                                    onClick={(event) =>
                                      removeReservationEmailField(event)
                                    }
                                  >
                                    <i
                                      className="fa fa-minus"
                        ...
                        <div className="col-md-10" key={index}>
                          <div className="input-group">
                            <input
                              ...
                              value={email}
                              onChange={(e) =>
                                handleCancellationEmailInputChange(index, e)
                              }
                              required
                              size="45"
                              maxLength="70"
                            ...
                            {index === 0 && (
                              ...
                              >
                                <button
                                  ...
                                  id="plus"
                                  onClick={(event) =>
                                    addCancellationEmailField(event)
                                  }
                                  style={{ marginRight: "5px" }}
                                >
                                  <i
                                ...
                                {cancellationemails.length > 1 && (
                                  <button
                                    ...
                                    id="minus"
                                    onClick={(event) =>
                                      removeCancellationEmailField(event)
                                    }
                                  >
                                    <i
                                      className="fa fa-minus"
            ...
            <div class="row mt-2">
              ...
              <div class="form-group col-md-3">
                ...
                <MultiSelect
                  ...
                  onChange={(selectedOption) =>
                    handleSingleSelectChange(selectedOption, "currency")
                  }
                  className="custom-select required"
                  required
                />
              ...
              <div class="form-group col-md-3">
                ...
                <MultiSelect
                  ...
                  onChange={(selectedOption) =>
                    handleSingleSelectChange(selectedOption, "timeZone")
                  }
              ...
              <div className="form-group col-md-12" style={{ display: "flex" }}>
                ...
                <div className="checkbox checkbox-success checkbox-inline">
                  <input
                    ...
                    value="yes"
                    onChange={handleCheckboxChange}
                    checked={formData.editHotels === "yes"}
                  />
                  <label htmlFor="editHotels">
                ...
                <div className="checkbox checkbox-success checkbox-inline">
                  <input
                    ...
                    value="yes"
                    onChange={handleCheckboxChange}
                    checked={formData.editAdminRates === "yes"}
                  />
                  <label htmlFor="editAdminRates">
                ...
                <div className="checkbox checkbox-success checkbox-inline">
                  <input
                    ...
                    value="yes"
                    onChange={handleCheckboxChange}
                    checked={formData.jointVenture === "yes"}
                  />
...
export default connect(mapStateToProps)(OfflineSuppliersEdit);
