...
const AccountsTaxSetupTaxMasterSearch = () => {
  return (
    <>
      <div className="container-fluid pt-0 p-4" id="content-pad">
        <Header2
          title="TAX"
          linkText1="Add Tax Master"
          link1={Constants.URLConstants.ACCOUNTSTAXSETUPTAXMASTERNEW}
        />
                        ...
                        <div className="actionCont">
                          <div className="input-group-addon">
                            <a
                              ...
                              data-original-title="Edit"
                              data-placement="top"
                              href="AccountsTaxsetupTaxMasteredit.html"
                            >
                              <i className="fa fa-pencil-square-o" />
                            </a>
                          </div>
...
export default AccountsTaxSetupTaxMasterSearch;
