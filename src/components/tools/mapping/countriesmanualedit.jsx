...
const CountriesManualEdit = () => {
 

  return (
    <>
      <Header2 title="COUNTRY DETAILS" linkText1="List Country" linkText2="Edit Country"  link1={Constants.URLConstants.TOOLSMAPPINGCOUNTRIESMANUAL}
       />
...
export default CountriesManualEdit;
