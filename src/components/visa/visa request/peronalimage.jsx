...
const VIsaPersonalImage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(
        updateOfflineVisaImages(id, { personalPhoto: s3Image.imagelink })
      );
  ...
  return (
    <>
      <Header2
        title="EDIT PERSONAL IMAGE"
        linkText1="Visa Bookings"
        linkText2=" Edit Personal Page"
                  ...
                  <div className="form-group col-md-12 row">
                    <div className="phps_row_1">
                      <div className="padd_5" align="left">
                        <label>
                          Personal Page Image(Size of file should be less than
                          39kb. (in jpeg, jpg, png, bmp or gif file format
                          only))
                        </label>
                        {imageId ? (
...
export default VIsaPersonalImage;
