...
const VIsaEditPassportImage2 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(
        updateOfflineVisaImages(id, { passportPageTwo: s3Image.imagelink })
      );
  ...
  return (
    <>
      <Header2
        title="EDIT OBSERVATION PAGE"
        linkText1="Visa Bookings"
        linkText2="  Edit Observation Page"
                  ...
                  <div className="form-group col-md-12 row">
                    <div className="phps_row_1">
                      <div className="padd_5" align="left">
                        <label>
                          Observation Page Image(Size of file should be less
                          than 39kb. (in jpeg, jpg, png, bmp or gif file format
                          only))
                        </label>
                        {imageId ? (
...
export default VIsaEditPassportImage2;
