...
const VIsaEditResidentPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(
        updateOfflineVisaImages(id, { residentPermit: s3Image.imagelink })
      );
                  ...
                  <div className="form-group col-md-12 row">
                    <div className="phps_row_1">
                      <div className="padd_5" align="left">
                        <label>
                          Resident Image(Size of file should be less than 39kb.
...
export default VIsaEditResidentPage;
