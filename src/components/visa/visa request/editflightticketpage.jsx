...
const VIsaEditFlightTicketPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(
        updateOfflineVisaImages(id, { flightTicket: s3Image.imagelink })
      );
                  ...
                  <div className="form-group col-md-12 row">
                    <div className="phps_row_1">
                      <div className="padd_5" align="left">
                        <label>
                          Flight Ticket Image(Size of file should be less than
...
export default VIsaEditFlightTicketPage;
