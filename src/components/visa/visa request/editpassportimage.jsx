...
const VIsaEditPassportImage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(
        updateOfflineVisaImages(id, { passportPageOne: s3Image.imagelink })
      );
  ...
  // console.log(passportPageOne);
  return (
    <>
      <Header2
        title="EDIT PASSPORT IMAGE"
        linkText1="Visa Bookings"
        linkText2=" Edit Passport Image"
                  ...
                  <div className="form-group col-md-12 row">
                    <div className="phps_row_1">
                      <div className="padd_5" align="left">
                        <label>
                          Passport Image(Size of file should be less than 39kb.
                          (in jpeg, jpg, png, bmp or gif file format only))
                        </label>
                        {imageId ? (
...
export default VIsaEditPassportImage;
