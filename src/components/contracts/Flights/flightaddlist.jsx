...
const ContractsFlightsAddList = () => {

  return (
    <>
      <Header2 title="ADD FLIGHT" linkText1="Flight List" linkText2="Add List" link1={Constants.URLConstants.CONTRACTSFLIGHTSSEARCH} />
...
export default ContractsFlightsAddList;
